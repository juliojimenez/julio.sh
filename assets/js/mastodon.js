      ...
      html += `
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text"><small class="text-muted"><a href="${el.querySelector('link').innerHTML}" class="text-decoration-none" target="_blank">${el.querySelector('pubDate').innerHTML}</a></small></p>
          </div>
          ${img}
        </div>
      `
